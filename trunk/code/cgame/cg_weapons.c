...
void CG_RegisterWeapon( int weaponNum ) {
	...
	//right handed
	if (Q_stricmp(bg_weaponlist[weaponNum].v_model,"<NULL>")) {
	...
	if (Q_stricmp(bg_weaponlist[weaponNum].snd_fire,"<NULL>") && weaponNum >= WP_REM58
	...
	if (Q_stricmp(bg_weaponlist[weaponNum].snd_reload,"<NULL>"))
...
void CG_AddPlayerWeapon( refEntity_t *parent, playerState_t *ps, centity_t *cent, int team ) {
	...
	if(ps && Q_stricmp(bg_weaponlist[weaponNum].v_model,"<NULL>")){
		clientInfo_t	*ci;
